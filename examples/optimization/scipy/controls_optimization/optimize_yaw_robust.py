...
power_initial_unc = fi.get_farm_power(include_unc=True, unc_options=unc_options)
...
power_opt_unc = fi.get_farm_power(include_unc=True, unc_options=unc_options)
fi.calculate_wake(yaw_angles=yaw_angles_unc)
power_opt_unc_robust = fi.get_farm_power(include_unc=True, unc_options=unc_options)
...
print(
    "Total Power Gain with Uncertainty using Original Yaw Angles = %.1f%%"
    % (100.0 * (power_opt_unc - power_initial_unc) / power_initial_unc)
)
print(
    "Total Power Gain with Uncertainty using Robust Yaw Angles = %.1f%%"
    % (100.0 * (power_opt_unc_robust - power_initial_unc) / power_initial_unc)
)
print("==========================================")
# =============================================================================
...
hor_plane = fi.get_hor_plane(
    x_resolution=400, y_resolution=100, height=fi.floris.farm.turbines[0].hub_height
)
